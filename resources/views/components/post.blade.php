  ...
  <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="./image-removebg-preview.png" class="p-0 w-100 img-fluid" style="height: 50vh" />
      </div>
      <div class="carousel-item">
        <img src="https://i.ibb.co/Jqh3rHv/img1.jpg" class="p-0 w-100 img-fluid" style="height: 50vh" />
      </div>
      <div class="carousel-item">
        <img src="./image-removebg-preview.png" class="p-0 w-100 img-fluid" style="height: 50vh" />
      </div>
            ...
            <div class="col-6 h-100">
              <div id="carouselExampleIntervalModal" class="carousel slide" data-bs-ride="carousel">
                ...
                <button class="carousel-control-prev" type="button"
                  data-bs-target="#carouselExampleIntervalModal" data-bs-slide="prev">
                  <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                  <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next" type="button"
                  data-bs-target="#carouselExampleIntervalModal" data-bs-slide="next">
                  <span class="carousel-control-next-icon" aria-hidden="true"></span>
                  <span class="visually-hidden">Next</span>
                </button>
              </div>
                  ...
                  <div class="col-8 d-flex justify-content-start align-content-center gap-3">
                    <button class="btn bg-transparent border-0 p-0">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" with="24"
                        height="24" class="bi bi-heart-fill text-danger" viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                          d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314" />
                      </svg>
                    </button>
