<div class="p-0 border-0 card rounded-0 post" style="max-width: 470px" data-post>
  <div class="px-0 bg-white border-0 card-header">
    <p class="card-title fs-5">
      <a class="d-flex align-items-center link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover"
        href="#" role="button">
        <img src="{{ $post->user->avatar }}" class="rounded-circle" height="22" alt="Avatar" loading="lazy" />&nbsp
        {{ $post->user->username }}
      </a>
  ...
  <div class="px-0 card-body">
    <div class="row d-flex justify-content-between align-content-center">
      <div class="gap-3 col-8 d-flex justify-content-start align-content-center">
        <button class="p-0 bg-transparent border-0 btn" data-post-like="{{ $post->id }}">
        ...
        <button class="p-0 bg-transparent border-0 btn" data-bs-target="#product-modal-{{ $post->id }}"
      ...
      <div class="col-4 d-flex justify-content-end">
        <button class="p-0 bg-transparent border-0 btn" data-post-save="{{ $post->id }}">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
            class="bi bi-bookmark-fill" viewBox="0 0 16 16">
            <path class="{{ $isSavedByUser }}"
    ...
    <div class="row">
      <p>
        <span class="fw-bold" data-likes-count>{{ $post->likes_count }}</span> likes,
        <span class="fw-bold" data-comments-count>{{ $post->comments_count }}</span> comments
      </p>
    </div>
    <p class="card-text">
      {{ $post->caption }}
              ...
              <div class="px-0">
                <div class="row d-flex justify-content-between align-content-center">
                  <div class="gap-3 col-8 d-flex justify-content-start align-content-center">
                    ...
                    <button class="p-0 bg-transparent border-0 btn" data-post-save="{{ $post->id }}">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        class="bi bi-bookmark-fil {{ $isSavedByUser }}" viewBox="0 0 16 16">
                        <path
                          d="M2 2v13.5a.5.5 0 0 0 .74.439L8 13.069l5.26 2.87A.5.5 0 0 0 14 15.5V2a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2" />
                      </svg>
                    </button>
                ...
                <form class="mb-2" class="comment-form" data-post-comment="{{ $post->id }}">
                  <input required class="border-0" type="text" placeholder="Add a comments..." name="comment">
