  ...
  <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="{{asset('images/img2.jpg')}}" class="p-0 w-100 img-fluid" />
      </div>
      <div class="carousel-item">
        <img src="https://i.ibb.co/Jqh3rHv/img1.jpg" class="p-0 w-100 img-fluid" />
      </div>
      <div class="carousel-item">
        <img src="{{asset('images/img2.jpg')}}" class="p-0 w-100 img-fluid" />
      </div>
  ...
  <div class="card-body px-0">
    <div class="row d-flex justify-content-between align-content-center">
      <div class="col-8 d-flex justify-content-start align-content-center gap-3">
        ...
        <button class="btn bg-transparent border-0 p-0" data-bs-target=".modal" data-bs-toggle="modal">
    ...
    <div class="row">
      <p>
        <span class="fw-bold">15</span> likes,
        <span class="fw-bold">3</span> comments
      </p>
    </div>
    <p class="card-text">
          ...
          <div class="row">
            <div class="col-6 h-100">
              <div id="carouselExampleIntervalModal" class="carousel slide" data-bs-ride="carousel">
                ...
                <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIntervalModal"
                  data-bs-slide="prev">
                  <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                  <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIntervalModal"
                  data-bs-slide="next">
                  <span class="carousel-control-next-icon" aria-hidden="true"></span>
                  <span class="visually-hidden">Next</span>
                </button>
            ...
            <div class="col-6">
              ...
              <div class="px-0">
                ...
                <input class="border-0" type="text" placeholder="Add a comments...">
              </div>
            </div>
          </div>
        </div>
