        ...
        <div class="w-full md:w-11/12 lg:w-10/12 xl:w-8/12">
            <div class="bg-white p-6 shadow-gradient rounded-lg">
                <div class="mb-4 text-xl font-bold text-gray-900 flex justify-between items-center">
                    Deleted Users
                    <a href="{{ route('admin.index') }}" class="btn-primary py-2 px-4 rounded bg-blue-500 hover:bg-blue-700 text-white">Admin Page</a>
                </div>
                                ...
                                <tr class="text-gray-700 hover:bg-gray-100">
                                    ...
                                    <td class="px-6 py-3 font-bold  text-center">
                                        <div class="flex space-x-2 items-center">
                                            <a href="{{ route('admin.restore', $user->id) }}" class="btn-success py-2 px-4 rounded inline-flex items-center justify-center">Restore</a>
                                            <form action="{{ route('admin.forceDelete', $user->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn-danger py-2 px-4 rounded inline-flex items-center justify-center">Delete Permanently</button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
